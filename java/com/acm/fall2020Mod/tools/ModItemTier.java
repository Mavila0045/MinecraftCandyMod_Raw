...
public enum ModItemTier implements IItemTier {
    ...
    private final int _harventLevel;
    ...
    ModItemTier(int harventLevel, int maxUses, float efficiency, float attackDamage, int enchantability, Supplier<Ingredient> repairMaterial)
    {
        this._harventLevel = harventLevel;
